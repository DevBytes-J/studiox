    ...
    <Frame>
      <section className="bg-[#181818] text-white py-32 relative overflow-hidden">
        <Image
          ...
          width={615}
          height={800}
          className="absolute left-[4%] top-1/2 -translate-y-1/2 rounded-bl-[24px] mx-[12px] lg:block hidden"
        />
        <Image
          src="/cta/bgi.png"
          alt=""
          width={600}
          height={500}
          className="absolute bottom-0 right-[4%] rounded-br-[24px] mx-[12px] lg:block hidden"
        />
